package com.sentinel.threat.exception;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleBusinessException(BusinessException ex, HttpServletRequest request) {
        ...
        log.warn("business_exception code={} path={} message={}", ex.errorCode(), request.getRequestURI(), ex.getMessage());
    ...
    ResponseEntity<ApiErrorResponse> handleUnhandled(Exception ex, HttpServletRequest request) {
        log.error("unhandled_exception path={} error={}", request.getRequestURI(), ex.getMessage(), ex);
